    ...
    <div class="container">
        ...
        <form @submit.prevent="submitForm">
            <div class="form-group">
                ...
                <input autofocus type="text" class="form-control" id="formGroupExampleInput" name="product_name"
                    placeholder="Product Name" v-model="item.name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="formGroupExampleInput3" placeholder="Price LKR"
                    v-model="item.price">
            </div>
